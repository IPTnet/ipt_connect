...
# Views parameters
app_version = "IPT_RUS2019"[3:]     # keyword for url parsing
# TODO:
# The construction `"IPT_RUS2019"[3:]` above is a dirty hack.
# We need to mention `IPT_RUS2019` to enable automated cloning,
...
fights = {
    ...
    'names': ['Scientific Fight 1','Scientific Fight 2','Scientific Fight 3','Scientific Fight 4','The Final']
}