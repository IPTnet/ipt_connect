...
class Participant(models.Model):
	...
	#photo = models.ImageField(upload_to=UploadToPathAndRename('IPT_RUS2019/id_photo'),help_text="Please use a clear ID photo. This will be used for badges and transportation cards.", null=True)
...
class Team(models.Model):
	...
	IOC = models.OneToOneField(User, on_delete=models.SET_NULL, null=True, blank=True,related_name='Team_IPT_RUS2019',verbose_name="Admin")
