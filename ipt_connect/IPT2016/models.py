...
class PhysicsFight(models.Model):
	...
	reporter = models.ForeignKey(Team,related_name='reporter_team')

	opponent = models.ForeignKey(Team,related_name='opponent_team')

	reviewer = models.ForeignKey(Team,related_name='reviewer_team')
...
class Participant(models.Model):
    ...
    photo = models.ImageField(upload_to='id_photo',help_text='Used for badges and transportation cards.')
