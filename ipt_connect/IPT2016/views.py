...
def participants_overview(request):
	...
	return render(request, 'IPT2016/participants_overview.html', {'participants': participants})

@cache_page(cache_duration)
def participant_detail(request, pk):
	participant = Participant.objects.get(pk=pk)
	average_grades=participant.compute_average_grades(verbose=False)
	return render(request, 'IPT2016/participant_detail.html', {'participant': participant, "average_grades": average_grades})
...
def jurys_overview(request):
	...
	return render(request, 'IPT2016/jurys_overview.html', {'jurys': jurys})
...
def jury_detail(request, pk):
	...
	mygrades = JuryGrade.objects.filter(jury=jury)
	return render(request, 'IPT2016/jury_detail.html', {'jury': jury, "grades": mygrades})
...
def tournament_overview(request):
	...
	return render(request, 'IPT2016/tournament_overview.html', {'teams': teams, 'rounds': rounds, 'pfs': pfs, 'roomnumbers':roomnumbers, 'orderedroundsperroom': orderedroundsperroom})

@cache_page(cache_duration)
def teams_overview(request):
	teams = Team.objects.all()
	teams = sorted(teams, key=lambda team: team.name)
	return render(request, 'IPT2016/teams_overview.html', {'teams': teams})
...
def team_detail(request, team_name):
	...
	return render(request, 'IPT2016/team_detail.html', {'team': team[0], 'participants': rankedparticipants, 'teamleaders': teamleaders, 'allrounds': allrounds, 'penalties': penalties})
...
def problems_overview(request):
	...
	return render(request, 'IPT2016/problems_overview.html', {'problems': problems})
...
def problem_detail(request, pk):
	...
	return render(request, 'IPT2016/problem_detail.html', {'problem': problem, "meangrades": meangrades, "teamresults": teamresults})
...
def rounds(request):
	...
	return render(request, 'IPT2016/rounds.html', {'orderedroundsperroom': orderedroundsperroom, 'finalrounds': finalrounds, "finalranking": finalranking})
...
def round_detail(request, pk):
	...
	return render(request, 'IPT2016/round_detail.html', {'round': round, 'jurygrades': jurygrades, 'meangrades': meangrades, "tacticalrejections": tacticalrejections, "eternalrejection": eternalrejection, "started": started, "finished": finished})
...
def finalround_detail(request, pk):
	...
	return render(request, 'IPT2016/finalround_detail.html', {'round': round, 'jurygrades': jurygrades, 'meangrades': meangrades, "tacticalrejections": tacticalrejections, "eternalrejection": eternalrejection, "started": started, "finished": finished})
...
def physics_fights(request):
	...
	return render(request, 'IPT2016/physics_fights.html', {'pf1': pf1, 'pf2': pf2, 'pf3': pf3, 'pf4': pf4})
...
def physics_fight_detail(request, pfid):
	...
	return render(request, 'IPT2016/physics_fight_detail.html', {"roomgrades": roomgrades})
...
def ranking(request):
	...
	return render(request, 'IPT2016/ranking.html', {'rankteams': rankteams})

@user_passes_test(lambda u: u.is_superuser)
def listing_participants(request):
	participants_objects = Participant.objects.all()

	return render(request, 'IPT2016/listing_participants.html',{'participants' : participants_objects})
